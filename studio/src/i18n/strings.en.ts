...
export const EN = {
  ...
  "exportPdf.stage.loading": "Loading items…",
  "exportPdf.stage.imagesPass1": "Preparing photos ({completed}/{total})…",
  "exportPdf.stage.renderPass1": "Laying out pages…",
  "exportPdf.stage.resolvingToc": "Building table of contents…",
  "exportPdf.stage.imagesPass2": "Preparing photos ({completed}/{total})…",
  "exportPdf.stage.renderPass2": "Rendering final PDF…",
