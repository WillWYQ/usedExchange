...
const BUTTON_BASE =
  "inline-flex items-center gap-2 rounded-full border-0 px-4 py-2 text-sm text-foreground/70 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/50 disabled:cursor-not-allowed disabled:opacity-40";
